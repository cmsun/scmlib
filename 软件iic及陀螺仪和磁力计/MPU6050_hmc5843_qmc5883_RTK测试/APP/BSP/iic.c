...
{    
    ...
    if(hiic->SDA_Pin > 0x0080)  //GPIO_Pin_7以上
    {
        hiic->SDA_Pin_No -= 8;
    }
    
//    GPIO_Initialize(scl_port, scl_pin, GPIO_Mode_Out_PP, GPIO_Speed_50MHz);
//    GPIO_Initialize(sda_port, sda_pin, GPIO_Mode_Out_PP, GPIO_Speed_50MHz);
}
