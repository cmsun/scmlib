...
#include "mpuxxxx.h"
//#define i2c_write   mpuxxxx_write_regs
//#define i2c_read    mpuxxxx_read_regs
//#define delay_ms    mpuxxxx_delay_ms
//#define get_ms      mpuxxxx_get_ms
//#define log_i(...)  mpuxxxx_log_i(__VA_ARGS__)
//#define log_e(...)  mpuxxxx_log_e(__VA_ARGS__)
